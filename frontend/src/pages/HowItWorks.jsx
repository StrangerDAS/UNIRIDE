      ...
      <div className="pt-20 pb-24 overflow-hidden relative">
        ...
        <div className="container-main relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-20 mt-10">
            ...
            >
              How <span className="text-brand">UNIRIDE</span> Works
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              UNIRIDE connects vehicle owners with riders in a fast, secure, and affordable way. Whether you need a ride or want to earn money, we've got you covered.
            </motion.p>
          </div>
